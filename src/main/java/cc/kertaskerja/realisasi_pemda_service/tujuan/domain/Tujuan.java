...
public record Tujuan(
    ...
    public static Tujuan of(
        ...
        return new Tujuan(null,
                ...
                targetId, target, realisasi, satuan, tahun, bulan, visiMisi, rumusPerhitungan, sumberData, faktorPenunjang, faktorPenghambat, jenisRealisasi, status, buktiPendukung,
                null, null, null, null);
    }
