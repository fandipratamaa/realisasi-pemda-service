...
@Schema(name = "LaporanRealisasiRenaksiIndividuResponse", description = "Response laporan realisasi renaksi individu per periode")
public record LaporanRealisasiRenaksiIndividuResponse(
        ...
        @Schema(description = "Renaksi laporan", example = "Renaksi A")
        String renaksi,
