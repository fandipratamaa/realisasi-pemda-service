...
@Schema(name = "LaporanRealisasiRenjaOpdResponse", description = "Response laporan realisasi renja OPD per periode")
public record LaporanRealisasiRenjaOpdResponse(
