...
public class SasaranIndividuControllerWebFluxTests {
    ...
    void whenBatchSubmit_thenReturnsSaveSasaranIndividu() throws Exception {
        SasaranIndividuRequest r1 = new SasaranIndividuRequest(null, "S1", "I1", "TAR-1", "100.0", 50.0, "unit1", "2025", "JANUARI", JenisRealisasi.NAIK, "1.01.0.00.0.00.01.0000", "198012312005011001", "Anon", "(realisasi/target)*100", "SIMDA");
        SasaranIndividuRequest r2 = new SasaranIndividuRequest(null, "S2", "I2", "TAR-2", "200.0", 75.0, "unit2", "2026", "FEBRUARI", JenisRealisasi.TURUN, "1.02.0.00.0.00.01.0000", "198012312005011002", "Anon", "(realisasi/target)*100", "SAKIP");
        ...
        SasaranIndividu s1 = SasaranIndividuService.buildUncheckedRealisasiSasaranIndividu(
                ...
                r1.nip(), r1.namaPegawai(), r1.kodeOpd(), r1.rumusPerhitungan(), r1.sumberData()
        );
        SasaranIndividu s2 = SasaranIndividuService.buildUncheckedRealisasiSasaranIndividu(
                ...
                r2.nip(), r2.namaPegawai(), r2.kodeOpd(), r2.rumusPerhitungan(), r2.sumberData()
        );
    ...
    void whenGetByTahunBulanNipAndRenjaId_thenReturnsSasaranIndividuList() {
        SasaranIndividu result = SasaranIndividuService.buildUncheckedRealisasiSasaranIndividu(
                ...
                "198012312005011001", "Anon", "1.01.0.00.0.00.01.0000", "(realisasi/target)*100", "SIMDA"
        );
    ...
    void whenGetByKodeOpdNipTahunBulan_thenReturnsSasaranIndividuList() {
        SasaranIndividu result = SasaranIndividuService.buildUncheckedRealisasiSasaranIndividu(
                "REN-001", "IND-001", "TAR-001", "100", 80.0,
                "%", "2025", "1", JenisRealisasi.NAIK,
                "1980123120050110010", "Anon", "1.01.0.00.0.00.01.0000", "(realisasi/target)*100", "SIMDA"
        );
