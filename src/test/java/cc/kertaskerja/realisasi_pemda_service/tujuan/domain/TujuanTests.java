...
public class TujuanTests {
    ...
    void testCapaianSingleTargetFormatTargetNonStandard() {
        ...
        Tujuan t2 = new Tujuan(305L, "T2", "TUJ-2",
                "I1", "IND-1",
               "TAR-2", "10,01", 10.01, "%",
                  "2025", "01", "Visi Misi 2", "(realisasi/target)*100", "Bappeda", "", "", JenisRealisasi.NAIK, TujuanStatus.UNCHECKED, "file.pdf", "bukti valid",
                 null, Instant.now(), Instant.now(), null);
    ...
    void testCapaianMultiTarget() {
        ...
        Tujuan t3 = new Tujuan(333L, "T4", "TUJ-4",
                ...
                "2025", "01", "Visi Misi 3", "(realisasi/target)*100", "BPS", "", "", JenisRealisasi.NAIK, TujuanStatus.UNCHECKED, "file.pdf", "bukti valid",
                null, Instant.now(), Instant.now(), null);
